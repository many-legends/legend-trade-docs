...
Our core belief is that we believe trading is the world's biggest video game. It has tens of millions of daily active users and the core gameplay loop is very addicting. People log in to Hyperliquid, Robinhood, Coinbase, or anything that allows you to trade every single day.

We're also at an influx where any type of asset is becoming tradable. Ten years ago, the only instrument of leverage that people like us had access to was an option. Now, we have perps on almost anything, mindshare perps, memecoins, prediction markets, and much, much more coming online.
...
On the left, you can see that you either have a choice to become a plumber or electrician or a job that is not easily replaceable by AI. 
In the middle you have a large segment of people who cannot find any job. Previously, it would be white-collar jobs, but those are being automated even faster than blue-collar. On the right, you have people looking for alternative sources of income. This can be Whop, this can be trading, this can be becoming an influencer or something like that.
