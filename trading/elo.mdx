...
Trading ELO is a composite rating from **0 to 2,400** that measures your overall quality as a trader using real trading performance -- risk management, returns, and capital deployed.
...
The factors combine risk-adjusted performance, return, and peak capital. The risk factor has a floor so a missing or non-positive Sortino does not erase the rest of a trader's performance signal.
...
- Missing, negative, or zero Sortino uses a **0.2 risk-factor floor**
