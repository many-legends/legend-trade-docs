...
By default, the trader's currently-open positions are mirrored into your copy wallet as soon as you start copying — proportionally sized, alongside any new trades they make.

If you'd rather start clean, turn on **Only copy newly opened positions** when you set up the copy. With it enabled, the trader's existing positions are skipped, and you'll only mirror activity they open after you start.
