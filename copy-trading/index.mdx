...
<Note>
  Copy trading is currently in **alpha**. Allocations range from \$50 to \$2500 per trader.
</Note>
...
- **Add funds** — Top up an active copy anytime, as long as your total allocation stays within the \$50–\$2500 range.
